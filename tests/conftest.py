...
# Base labels fixture - used by test_classify_images
_BASE_LABELS = {
    "cat_01.jpg": ["cat"],
...
# Base results fixture - used by test_adjust_results4_isadog
# Format: {filename: [pet_label, classifier_label, match_int]}
_BASE_RESULTS = {
...
# Base adjust_results4_isadog fixture - used by test_adjust_results4_isadog
_BASE_ADJUST_RESULTS4_ISADOG = {
...
@pytest.fixture
def labels():
    """Provide a fresh copy of labels for each test."""
    return copy.deepcopy(_BASE_LABELS)


@pytest.fixture
def results():
    """Provide a fresh copy of results dictionary for each test.

    Format: {filename: [pet_label, classifier_label, match_int]}
    """
    return copy.deepcopy(_BASE_RESULTS)


@pytest.fixture
def adjusted_results4_isadog():
    """Provide a fresh copy of adjust_results4_isadog dictionary for each test.

    Format: {filename: [pet_label, classifier_label, match_int]}
    """
    return copy.deepcopy(_BASE_ADJUST_RESULTS4_ISADOG)


@pytest.fixture
def statistics():
    """Provide a fresh copy of statistics dictionary for each test."""
    return copy.deepcopy(_BASE_STATISTICS)
